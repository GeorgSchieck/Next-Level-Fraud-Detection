...
$contact_email_to = "rs91288@gmail.com";

// Subject prefix
$contact_subject_prefix = "Kontaktformular: ";

// Name too short error text
$contact_error_name = "Name too short or Empty;

// Email invalid error text
$contact_error_email = "Please enter a valid e-mail address";

// Subject too short error text
$contact_error_subject = "Topic too short or empty";
